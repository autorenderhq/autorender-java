...
dependencies {
    testImplementation(project(":autorender-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../autorender-java-core/src/main/resources/META-INF/proguard/autorender-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("io.autorender.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../autorender-java-core/src/main/resources/META-INF/proguard/autorender-java-core.pro",
