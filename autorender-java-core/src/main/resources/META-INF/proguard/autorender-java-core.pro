...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class io.autorender.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class io.autorender.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class io.autorender.** {
    <init>(...);
