...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FolderDeleteParams = builder().build()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(folderDeleteParams: FolderDeleteParams) = apply {
            folderNo = folderDeleteParams.folderNo
            ...
            additionalBodyProperties = folderDeleteParams.additionalBodyProperties.toMutableMap()
        }
    ...
    override fun hashCode(): Int =
        Objects.hash(folderNo, additionalHeaders, additionalQueryParams, additionalBodyProperties)

    override fun toString() =
        "FolderDeleteParams{folderNo=$folderNo, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
