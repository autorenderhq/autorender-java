...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(folderRenameParams: FolderRenameParams) = apply {
            folderNo = folderRenameParams.folderNo
    ...
    override fun hashCode(): Int =
        Objects.hash(folderNo, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "FolderRenameParams{folderNo=$folderNo, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
