...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileUpdateResponse: FileUpdateResponse) = apply {
            id = fileUpdateResponse.id
            createdAt = fileUpdateResponse.createdAt
            extension = fileUpdateResponse.extension
            fileNo = fileUpdateResponse.fileNo
            fileSize = fileUpdateResponse.fileSize
            folderId = fileUpdateResponse.folderId
            format = fileUpdateResponse.format
            height = fileUpdateResponse.height
            metaData = fileUpdateResponse.metaData
            name = fileUpdateResponse.name
            path = fileUpdateResponse.path
            updatedAt = fileUpdateResponse.updatedAt
            url = fileUpdateResponse.url
            width = fileUpdateResponse.width
            workspaceNo = fileUpdateResponse.workspaceNo
    ...
    override fun toString() =
        "FileUpdateResponse{id=$id, createdAt=$createdAt, extension=$extension, fileNo=$fileNo, fileSize=$fileSize, folderId=$folderId, format=$format, height=$height, metaData=$metaData, name=$name, path=$path, updatedAt=$updatedAt, url=$url, width=$width, workspaceNo=$workspaceNo, additionalProperties=$additionalProperties}"
}
