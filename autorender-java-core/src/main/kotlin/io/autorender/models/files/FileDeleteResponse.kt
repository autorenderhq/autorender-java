...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(fileDeleteResponse: FileDeleteResponse) = apply {
            message = fileDeleteResponse.message
         ...
         */
        fun build(): FileDeleteResponse =
            FileDeleteResponse(message, additionalProperties.toMutableMap())
    }
    ...
    override fun toString() =
        "FileDeleteResponse{message=$message, additionalProperties=$additionalProperties}"
}
