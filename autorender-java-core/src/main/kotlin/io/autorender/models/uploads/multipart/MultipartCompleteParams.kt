...
/**
 * Finalize a multipart upload after all parts have been uploaded. Assembles the parts and creates
 * the file record.
 */
class MultipartCompleteParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [MultipartCompleteParams].
         *
    ...
    /** A builder for [MultipartCompleteParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(multipartCompleteParams: MultipartCompleteParams) = apply {
            body = multipartCompleteParams.body.toBuilder()
            additionalHeaders = multipartCompleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = multipartCompleteParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [MultipartCompleteParams].
         *
         ...
         */
        fun build(): MultipartCompleteParams =
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(checkRequired("sessionId", sessionId), additionalProperties.toMutableMap())
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is MultipartCompleteParams &&
            body == other.body &&
    ...
    override fun toString() =
        "MultipartCompleteParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
