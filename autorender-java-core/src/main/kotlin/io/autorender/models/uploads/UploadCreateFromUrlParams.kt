...
/**
 * Download a file from a remote HTTP/HTTPS URL and store it in your AutoRender workspace. Supports
 * optional transformations and metadata.
 */
...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{remoteUrl=$remoteUrl, customId=$customId, fileName=$fileName, folder=$folder, metadata=$metadata, randomPrefix=$randomPrefix, tags=$tags, transform=$transform, webhookUrl=$webhookUrl, additionalProperties=$additionalProperties}"
    }
