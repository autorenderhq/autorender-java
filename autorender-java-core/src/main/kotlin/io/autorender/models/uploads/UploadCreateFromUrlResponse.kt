...
/** Upload created */
class UploadCreateFromUrlResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UploadCreateFromUrlResponse].
         *
    ...
    /** A builder for [UploadCreateFromUrlResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(uploadCreateFromUrlResponse: UploadCreateFromUrlResponse) = apply {
            id = uploadCreateFromUrlResponse.id
            createdAt = uploadCreateFromUrlResponse.createdAt
            customId = uploadCreateFromUrlResponse.customId
            extension = uploadCreateFromUrlResponse.extension
            fileNo = uploadCreateFromUrlResponse.fileNo
            folderNo = uploadCreateFromUrlResponse.folderNo
            height = uploadCreateFromUrlResponse.height
            isDuplicate = uploadCreateFromUrlResponse.isDuplicate
            metadata = uploadCreateFromUrlResponse.metadata
            mimeType = uploadCreateFromUrlResponse.mimeType
            name = uploadCreateFromUrlResponse.name
            path = uploadCreateFromUrlResponse.path
            size = uploadCreateFromUrlResponse.size
            tags = uploadCreateFromUrlResponse.tags.map { it.toMutableList() }
            thumbnail = uploadCreateFromUrlResponse.thumbnail
            uploadSource = uploadCreateFromUrlResponse.uploadSource
            url = uploadCreateFromUrlResponse.url
            width = uploadCreateFromUrlResponse.width
            workspaceId = uploadCreateFromUrlResponse.workspaceId
            format = uploadCreateFromUrlResponse.format
            hash = uploadCreateFromUrlResponse.hash
            isPrivate = uploadCreateFromUrlResponse.isPrivate
            additionalProperties = uploadCreateFromUrlResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UploadCreateFromUrlResponse].
         *
         ...
         */
        fun build(): UploadCreateFromUrlResponse =
     ...
     *   expected type.
     */
    fun validate(): UploadCreateFromUrlResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UploadCreateFromUrlResponse &&
            id == other.id &&
