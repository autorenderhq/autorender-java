...
import io.autorender.core.http.PhantomReachableClosingHttpClient
import io.autorender.core.http.QueryParams
import io.autorender.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `autorender-java-client-okhttp` or implement your own.
     *
    ...
    companion object {
        ...
        const val PRODUCTION_URL = "https://upload.autorender.io"
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            ...
            (System.getProperty("autorender.baseUrl") ?: System.getenv("AUTORENDER_BASE_URL"))
                ?.let { baseUrl(it) }
            (System.getProperty("autorender.apiKey") ?: System.getenv("AUTORENDER_API_KEY"))?.let {
                apiKey(it)
            }
            System.getenv("AUTORENDER_CUSTOM_HEADERS")?.let { customHeadersEnv ->
