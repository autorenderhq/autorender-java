...
/**
 * A client for interacting with the Autorender REST API synchronously. You can also switch to
...
interface AutorenderClient {
     ...
     * this client.
     */
    fun async(): AutorenderClientAsync
    ...
    /** A view of [AutorenderClient] that provides access to raw HTTP responses for each method. */
