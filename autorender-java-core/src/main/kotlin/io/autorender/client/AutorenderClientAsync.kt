...
/**
 * A client for interacting with the Autorender REST API asynchronously. You can also switch to
 ...
 * may call [close].
 */
interface AutorenderClientAsync {
    ...
    /** Upload endpoints (API key required) */
    fun multipartUploads(): MultipartUploadServiceAsync
    ...
    /**
     * A view of [AutorenderClientAsync] that provides access to raw HTTP responses for each method.
     */
    interface WithRawResponse {
        ...
        /** Upload endpoints (API key required) */
        fun multipartUploads(): MultipartUploadServiceAsync.WithRawResponse
    }
}
