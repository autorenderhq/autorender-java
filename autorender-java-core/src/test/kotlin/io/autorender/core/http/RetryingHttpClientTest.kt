...
package io.autorender.core.http
...
import io.autorender.client.okhttp.OkHttpClient
import io.autorender.core.RequestOptions
import io.autorender.core.Sleeper
import io.autorender.errors.AutorenderRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw AutorenderRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            AutorenderRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
