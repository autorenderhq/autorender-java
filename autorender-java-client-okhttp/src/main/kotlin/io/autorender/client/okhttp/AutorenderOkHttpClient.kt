...
package io.autorender.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import io.autorender.client.AutorenderClient
import io.autorender.client.AutorenderClientImpl
...
/**
 * A class that allows building an instance of [AutorenderClient] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class AutorenderOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AutorenderClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): AutorenderClient = builder().fromEnv().build()
    }

    /** A builder for [AutorenderOkHttpClient]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [io.autorender.core.jsonMapper]. The default is usually sufficient and rarely
         ...
         *
         * Defaults to the production environment: `https://upload.autorender.io`.
         */
        ...
        /**
         * Returns an immutable instance of [AutorenderClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AutorenderClient =
            AutorenderClientImpl(
                clientOptions
                    .httpClient(
