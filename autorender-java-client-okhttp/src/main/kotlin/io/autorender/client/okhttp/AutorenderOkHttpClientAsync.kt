...
/**
 * A class that allows building an instance of [AutorenderClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class AutorenderOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AutorenderClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): AutorenderClientAsync = builder().fromEnv().build()
    }

    /** A builder for [AutorenderOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AutorenderClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AutorenderClientAsync =
            AutorenderClientAsyncImpl(
                clientOptions
                    .httpClient(
